...
var Author = require('./server/models/authorModel')
var Genre = require('./server/models/genreModel')
var BookInstance = require('./server/models/bookinstanceModel')
...
function authorCreate(first_name, family_name, d_birth, d_death, cb) {
  authordetail = {fname:first_name , lname: family_name }
